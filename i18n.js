...
const dict={
  ru:{
    ...
    queryPlaceholder:'Например: боится встать и плохо ходит, риск падения, одышка…',search:'Найти',
  ...
  de:{
    ...
    queryPlaceholder:'Zum Beispiel: hat Angst aufzustehen und geht schlecht, Sturzrisiko, Dyspnoe…',search:'Suchen',
